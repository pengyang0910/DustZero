...
#ifndef __NavMsg_GridMapUpdate_t_hpp__
#define __NavMsg_GridMapUpdate_t_hpp__
...
namespace NavMsg
{
    ...
    int GridMapUpdate_t::encode(void *buf, int offset, int maxlen) const
    {
        int pos = 0, tlen;
    ...
    int GridMapUpdate_t::decode(const void *buf, int offset, int maxlen)
    {
        int pos = 0, thislen;
    ...
    int GridMapUpdate_t::getEncodedSize() const
    {
        return 8 + _getEncodedSizeNoHash();
    }

    int64_t GridMapUpdate_t::getHash()
    {
        static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
        return hash;
    }

    const char *GridMapUpdate_t::getTypeName()
    {
        return "GridMapUpdate_t";
    }

    int GridMapUpdate_t::_encodeNoHash(void *buf, int offset, int maxlen) const
    {
        int pos = 0, tlen;
    ...
    int GridMapUpdate_t::_decodeNoHash(const void *buf, int offset, int maxlen)
    {
        int pos = 0, tlen;
    ...
    int GridMapUpdate_t::_getEncodedSizeNoHash() const
    {
        int enc_size = 0;
    ...
    uint64_t GridMapUpdate_t::_computeHash(const __lcm_hash_ptr *)
    {
        uint64_t hash = 0x28fc4375fc6c42ffLL;
