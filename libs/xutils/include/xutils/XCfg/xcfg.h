...
class ConfigFile
{
  ...
  public: ConfigFile(std::string filePath);
  ...
  public: const char *ReadString(int section, 
                                 const char *name, 
                                 const char *value);
  public: const char *ReadString(const char *name, 
                                 const char *value);
  ...
  private: void WriteString(int section, 
                            const char *name, 
                            const char *value);
  public: void WriteString(const char *name, 
                            const char *value);
  ...
  public: int ReadInt(int section, 
                      const char *name, 
                      int value);
  public: int ReadInt(const char *name, 
                      int value);
  ...
  private: void WriteInt(int section, 
                         const char *name, 
                         int value);
  public: void WriteInt(const char *name, 
                         int value);
  ...
  public: double ReadFloat(int section, 
                           const char *name, 
                           double value);
  public: double ReadFloat(const char *name, 
                           double value);
  ...
  private: void WriteFloat(int section, 
                           const char *name, 
                           double value);
  public: void WriteFloat(const char *name, 
                           double value);    
  ...
  public: double ReadLength(int section, 
                            const char *name, 
                            double value);
  public: double ReadLength(const char *name, 
                            double value);
  ...
  private: void WriteLength(int section, 
                            const char *name, 
                            double value);
  private: void WriteLength(const char *name, 
                            double value);
  ...
  public: bool SaveTokens(FILE *file);
...
typedef   ConfigFile  XCfg;
//#define     XCfg    ConfigFile
