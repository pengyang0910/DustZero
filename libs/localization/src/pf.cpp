...
void pf_update_sensor(pf_t *pf, pf_sensor_model_fn_t sensor_fn, void *sensor_data)
{
  ...
  pf->total_score = total;//add for localization missing
...
void pf_update_resample(pf_t *pf)
{
  ...
  */
  ...
  while(set_b->sample_count < pf->max_samples)
  {
    ...
    else
    {
      ...
      */
      ...
      samCount++;
      //printf("add sample a:[%3d],total count:%d pose to sample b pose,set b sample count:%d,max samples:%d  \n",i,samCount,set_b->sample_count,pf->max_samples);
    }
  ...
  //printf("new sample b count limited:%d \n",samCount);
  //printf("\n");
...
void pf_cluster_stats(pf_t *pf, pf_sample_set_t *set)
{
  ...
  for (i = 0; i < set->sample_count; i++)
  {
    ...
    //printf("cluster seq:%d,sample id:%d,weight:%f,x:%f,y:%f,theta:%f \n",cidx,i,sample->weight,sample->pose.v[0],sample->pose.v[1],sample->pose.v[2]);
