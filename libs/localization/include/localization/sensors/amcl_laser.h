...
class AMCLLaser : public AMCLSensor
{
  ...
  public: static double laserHitThroughScore(AMCLLaserData *data,pf_vector_t amclPose); 
  public: static double fowardHitScore(AMCLLaserData *data,pf_vector_t amclPose,int startNum,int endNum,float ldist);
  public: static double bresenham(const unsigned int a,const unsigned int b,const int offsetA,const int offsetB,unsigned int offset,map_t* map);
