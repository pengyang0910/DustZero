...
struct PointAccumulator{
	...
	*/
	...
	inline void clear(bool value, const Point& p=Point(0,0));
	inline void updateNew(bool value, int nvisit, const Point& p=Point(0,0));
...
void PointAccumulator::clear(bool value, const Point& p){
	visits=0;
	n=0;
	acc.x=0;
	acc.y=0;
...
void PointAccumulator::updateNew(bool value, int nvisit, const Point& p)
{
	visits+= nvisit;
}
