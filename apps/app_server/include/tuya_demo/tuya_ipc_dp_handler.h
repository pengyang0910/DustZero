...
extern int tuya_adapter_wifi_get_work_mode(OUT WF_WK_MD_E *mode);
extern int tuya_adapter_wifi_get_mac(WF_IF_E mode, OUT NW_MAC_S *mac);
extern int tuya_adapter_wifi_ap_start(WF_AP_CFG_IF_S *ap_cfg);
extern int tuya_adapter_wifi_ap_stop();
