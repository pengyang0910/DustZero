...
//#include "tuya_ipc_stream_storage_common.h"
...
#define SS_ALBUM_MAX_NUM (4) //支持的相册数量
...
#define ABS_PATH_FILE_LEN 128 //完整路径文件名最大长度
...
BOOL_T is_ss_inited();
BOOL_T is_ss_write_mode_enabled();
...
typedef struct __TUYA_IPC_ALBUM_INFO 
{
    INT_T cnt;
    CHAR_T albumName[SS_ALBUM_MAX_NUM][SS_BASE_FILE_NAME_LEN];
}TUYA_IPC_ALBUM_INFO_S;
...
typedef struct
{
    ...
    TUYA_IPC_ALBUM_INFO_S album_info;
