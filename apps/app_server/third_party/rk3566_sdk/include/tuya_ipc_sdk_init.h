...
typedef enum
{
    WIFI_GWCM_OLD,                  // do not have low power mode
    WIFI_GWCM_LOW_POWER,            // with low power mode
    WIFI_GWCM_SPCL_MODE,            // special with low power mode
    WIFI_GWCM_OLD_PROD,             // GWCM_OLD mode with product
    WIFI_GWCM_LOW_POWER_AUTOCFG,    // with low power mode && auto cfg
    WIFI_GWCM_SPCL_AUTOCFG         // special with low power mode && auto cfg
}WIFI_INIT_METH_E;
 ...
 * \return OPERATE_RET
 */
OPERATE_RET tuya_ipc_start_sdk(IN CONST WIFI_INIT_METH_E wifi_methed_mode, IN CONST WIFI_INIT_MODE_E wifi_mode,IN CONST char *pToken);

OPERATE_RET tuya_ipc_multi_dev_start_sdk(IN CONST WIFI_INIT_METH_E wifi_methed_mode, IN CONST WIFI_INIT_MODE_E wifi_mode,IN CONST char *pToken,TUYA_IPC_SUB_DEV_OTA_INFO_S *p_ota_info);
