...
OPERATE_RET tuya_imm_cloud_put_fragment_data_start(IN CLOUD_CONFIG_S *config,
                                                                    IN CHAR_T *method,
                                                                    IN CLOUD_UPLOAD_PATH_E path,
                                                                    IN CHAR_T *file,
                                                                    IN CHAR_T *content_type,
...
OPERATE_RET tuya_imm_cloud_put_fragment_data_process(INOUT PVOID_T *p_handle, IN CONST CHAR_T *data, IN CONST INT_T len);
