...
nav_map_uncompressed obsMap((int8_t)NAV_COM_MAP_TYPE_OBS, NAV_COM_SLAM_MAP_UNIT_MM, NAV_COM_MAP_MAX_WIDTH_MM / NAV_COM_SLAM_MAP_UNIT_MM, NAV_COM_MAP_MAX_HEIGHT_MM / NAV_COM_SLAM_MAP_UNIT_MM);
nav_map_uncompressed stuckMap((int8_t)NAV_COM_MAP_TYPE_STUCK, NAV_COM_SLAM_MAP_UNIT_MM, NAV_COM_MAP_MAX_WIDTH_MM / NAV_COM_SLAM_MAP_UNIT_MM, NAV_COM_MAP_MAX_HEIGHT_MM / NAV_COM_SLAM_MAP_UNIT_MM);
nav_map_uncompressed cleanMap((int8_t)NAV_COM_MAP_TYPE_CLEANED, NAV_COM_SLAM_MAP_UNIT_MM, NAV_COM_MAP_MAX_WIDTH_MM / NAV_COM_SLAM_MAP_UNIT_MM, NAV_COM_MAP_MAX_HEIGHT_MM / NAV_COM_SLAM_MAP_UNIT_MM);
nav_map_uncompressed obscleanMap((int8_t)NAV_COM_MAP_TYPE_OBS_CLEANED, NAV_COM_SLAM_MAP_UNIT_MM, NAV_COM_MAP_MAX_WIDTH_MM / NAV_COM_SLAM_MAP_UNIT_MM, NAV_COM_MAP_MAX_HEIGHT_MM / NAV_COM_SLAM_MAP_UNIT_MM);
